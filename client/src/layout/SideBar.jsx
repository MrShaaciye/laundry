...
const SideBar = () => {
  ...
  return (
    ...
    >
      <Sidebar collapsed={isCollapsed} toggled={toggled} onBackdropClick={() => setToggled(false)} onBreakoint={setBroken} image="/assets/17372.jpg" breakPoint="md" style={{ height: "100%" }}>
